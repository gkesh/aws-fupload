...
export interface FUploadApiProps {
...
export class FUploadApi extends Construct {
  /** allows accessing the counter function */
  public readonly handler: lambda.Function;

  constructor(scope: Construct, id: string, props: FUploadApiProps) {
    super(scope, id);
    ...
    this.handler = new lambda.Function(this, "handler", {
      ...
      environment: {
        FUPLOAD_TABLE_NAME: table.tableName,
      },
    });
